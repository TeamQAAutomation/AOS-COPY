...
describe("AOS Registration functionality", () => {
  ...
  const testcase="AOSRE-6197".toString()
  ...
  const screenshotName = "Fail_AOSRE-6197_" + dateTime;
...
Cypress.on("fail", (err, runnable) => {
  ...
  it("AOSRE-6197: Registration test", () => {
    ...
    //this.elements.cookiesButton().click({force:true});
