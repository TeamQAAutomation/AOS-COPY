...
describe("Attachedfiles are mandatory in Reg. form", () => {
  ...
  const screenshotName = "Fail_AOSRE-21377_" + dateTime;
...
Cypress.on("fail", (err, runnable) => {
  ...
  it("AOSRE-21377: Attachedfiles are mandatory in Reg. form", () => {
    ...
    "Germany","DE","Test org","Test street","45612","germany","Mr","MALE","testlast12","testfirst34","English (United Kingdom)","ENGLISH_UK","(UTC +01:00) Central European Time","CET");
    cy.wrap().then(() => {
