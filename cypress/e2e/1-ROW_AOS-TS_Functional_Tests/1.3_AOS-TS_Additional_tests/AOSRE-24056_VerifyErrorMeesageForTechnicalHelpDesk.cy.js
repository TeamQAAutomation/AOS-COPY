...
describe("Techical Help Desk", () => {
  ...
  const testcase = "AOSRE-24056".toString()
  ...
  const screenshotName = "Fail_AOSRE-24056_" + dateTime;
  ...
  it("AOSRE-24056: Technical Help Desk form", () => {
    ...
    aos_TechnicalHelpDesk.should_Verify_Errors_With_EmptyFields_In_TechnicalHelpDesk();
    cy.wrap().then(() => {6
