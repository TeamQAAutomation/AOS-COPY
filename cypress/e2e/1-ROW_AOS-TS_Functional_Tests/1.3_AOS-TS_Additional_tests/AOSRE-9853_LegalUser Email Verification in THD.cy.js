...
describe("LegalUserEmailVerificationinTHD", () => {
  ...
  const testcase = "AOSRE-9853".toString()
  ...
  const screenshotName = "Fail_AOSRE-9853_" + dateTime;
  ...
  it("AOSRE-9853: LegalUserEmailVerificationinTHD", () => {
    ...
    cy.wait(15000);
    //Click on Form  Technical  Help Form 
    aos_THD.should_Click_TechnicalHelpDesk();
    //HelpDesk Form  Filling 
    aos_THD.should_Fill_TechnicalHelpDesk_Form();
    //Verify Legal User by email 
