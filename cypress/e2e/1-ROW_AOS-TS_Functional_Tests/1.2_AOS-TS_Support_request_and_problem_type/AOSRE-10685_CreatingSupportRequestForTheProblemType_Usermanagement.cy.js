...
describe("Checking Support Request form ", () => {
    ...
    const problemtype = "User management";
    ...
    const testcase = "AOSRE-10685".toString()
    ...
    let errorMessage = ""
    const screenshotName = "Fail_AOSRE-10685_" + dateTime;
  ...
  throw err;
    ...
    it("AOSRE-5971 : Support Request Creation ", () => {
        ...
        //Creating support request for the problem type usermanagement
