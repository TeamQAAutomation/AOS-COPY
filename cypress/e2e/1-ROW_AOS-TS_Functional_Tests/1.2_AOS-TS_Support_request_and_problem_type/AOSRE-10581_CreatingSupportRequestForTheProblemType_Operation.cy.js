...
describe("Checking Support Request form ", () => {
    ...
    const testcase = "AOSRE-10581".toString()
    ...
    let errorMessage = ""
    const screenshotName = "Fail_AOSRE-10581_" + dateTime;
  ...
  throw err;
    ...
    it("AOSRE-10581 : Creating support request for the problem type Operation ", () => {
        //Current Test Title
        ...
        //Creating support request for the problem type Operation
