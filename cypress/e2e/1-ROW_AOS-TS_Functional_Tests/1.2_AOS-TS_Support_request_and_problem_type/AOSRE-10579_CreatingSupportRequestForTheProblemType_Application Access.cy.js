...
describe("Creating Support Request form for Problem Type Application Access", () => {
    ...
    const problemtype = "Application access";
    ...
    const testcase = "AOSRE-10579".toString()
    ...
    let errorMessage = ""
    const screenshotName = "Fail_AOSRE-10579_" + dateTime;
  ...
  throw err;
    ...
    it("AOSRE-10579 : Support Request Creation for Application Access problem Type ", () => {
        //Current Test Title
        ...
        //Creating Support Request for the ProblemType Application Access
