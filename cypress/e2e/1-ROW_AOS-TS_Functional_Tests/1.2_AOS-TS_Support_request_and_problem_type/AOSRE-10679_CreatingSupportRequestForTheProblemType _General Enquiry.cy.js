...
describe("Checking Support Request form ", () => {
    ...
    const problemtype = "General enquiry";
    ...
    const testcase = "AOSRE-10679".toString()
    ...
    let errorMessage = ""
    const screenshotName = "Fail_AOSRE-10679_" + dateTime;
  ...
  throw err;
    ...
    it("AOSRE-10679 : Support Request Creation for Problem Type General Enquiry", () => {
        //Current Test Title
        ...
        //Support Request Creation for Problem Type General Enquiry
