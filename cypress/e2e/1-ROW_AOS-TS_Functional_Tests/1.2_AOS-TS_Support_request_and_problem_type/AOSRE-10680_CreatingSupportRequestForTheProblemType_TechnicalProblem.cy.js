...
describe("Checking Support Request form ", () => {
    ...
    const affectedApplication = "Portal";
    const problemtype = "Technical problem";
    ...
    const testcase = "AOSRE-10680".toString()
    ...
    let errorMessage = ""
    const screenshotName = "Fail_AOSRE-10680_" + dateTime;
  ...
  throw err;
    ...
    it("AOSRE-10680 : Creating support request for the problem type Technical Problem ", () => {
        //Current Test Title
        ...
        //Creating support request for the problem type Technical Problem
