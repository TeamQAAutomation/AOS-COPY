...
describe("Checking Support Request form ", () => {
    ...
    const problemtype = "Installation";
    ...
    const testcase = "AOSRE-10580".toString()
    ...
    let errorMessage = ""
    const screenshotName = "Fail_AOSRE-10580_" + dateTime;
  ...
  throw err;
    ...
    it("AOSRE-10580 : Support Request Creation for Problem Type Installation ", () => {
        //Current Test Title
        ...
        //Creating Support Request for the problem type Installation
