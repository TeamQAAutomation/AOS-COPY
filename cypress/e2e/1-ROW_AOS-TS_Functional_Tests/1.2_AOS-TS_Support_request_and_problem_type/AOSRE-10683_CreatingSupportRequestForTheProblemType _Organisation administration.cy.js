...
describe("Checking Support Request form ", () => {
    ...
    const problemtype = "Organisation administration";
    ...
    const testcase = "AOSRE-10683".toString()
    ...
    let errorMessage = ""
    const screenshotName = "Fail_AOSRE-10683_" + dateTime;
  ...
  throw err;
    ...
    it("AOSRE-10683 : Support Request Creation for problem type Organisation Administration", () => {
        //Current Test Title
      ...
      cy.logStepStatus(ArraySteps, "step1", "Pass");
        ...
        //creating support request for problem type Adminstration
