...
describe("Checking Support Request form ", () => {
    ...
    const problemtype = "Technical question";
    ...
    const testcase = "AOSRE-10583".toString()
    ...
    let errorMessage = ""
    const screenshotName = "Fail_AOSRE-10583_" + dateTime;
  ...
  throw err;
    ...
    it("AOSRE-10583 : Creating support request for the problem type Technical Question ", () => {
        //Current Test Title
        ...
        //Creating support request for the problem type Technical Question
