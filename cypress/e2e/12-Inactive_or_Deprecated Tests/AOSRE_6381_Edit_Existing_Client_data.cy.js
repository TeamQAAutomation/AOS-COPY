...
describe("AOSRE_6381_Edit_Existing_Client_data", () => {
  ...
  const testcase = "AOSRE-6381".toString();
  ...
  const screenshotName = "Fail_AOSRE-6381_" + dateTime;
  ...
  it("AOSRE_6381_Edit_Existing_Client_data", () => {
    ...
    Adminuser.Verify_Client_management("test1234");
    cy.wrap().then(() => {
      cy.logStepStatus(ArraySteps, "step6", "Pass");
    });
    //delete create new client
